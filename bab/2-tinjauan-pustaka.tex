...
\textit{self-attention} adalah salah satu komponen penting dalam implementasi \textit{transformer}. \textit{self-attention} lah yang membuat token representasi dari teks, menjadi memiliki bias sehingga dapat dijadikan dasar untuk proses selanjutnya.
